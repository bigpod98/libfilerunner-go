...
- [x] Harden remote claim behavior against concurrent workers (reduce duplicate-claim race windows)
- [x] Improve large-queue claim performance (avoid full list+sort when only next item(s) are needed)
- [x] Add tests for cancellation during claim/finalize and partial-failure scenarios
- [x] Add tests for concurrent claimers across backends
